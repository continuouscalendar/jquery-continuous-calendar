...
(function($) {
  ...
  $(window).load(function() {
    ...
    runTest();
    $("#fullReport").text(fullReport.join("\n"));
  });
  ...
  function test(name, callback) {
    ...
    synchronize(function() {
      ...
      for (var i = 0; i < config.assertions.length; i++) {
        ...
        //eeroan modification for JUnit report
        if (!assertion.result) {
          moduleReport.push("  " + (assertion.message || "(no message)"));
        }
   ...
   */
  function reset() {
    //SEE http://www.mail-archive.com/jquery-dev@googlegroups.com/msg01342.html
